...
def test_failqueue():
    client_name = "sd-test-client-" + str(randint(0, 10000))
    bucket_id = "test-bucket-" + str(randint(0, 10000))
    bucket_etype = "test"

    input("Make sure sd-server isn't running, then press enter > ")
    ...
    input("Start sd-server with --testing, then press enter > ")
