...
def flood(events: List[Event], pulsetime: float = 5) -> List[Event]:
    ...
    """
    # Originally written in sd-research: https://github.com/ActivityWatch/sd-analysis/blob/7da1f2cd8552f866f643501de633d74cdecab168/sd_analysis/flood.py
    # NOTE: This algorithm has a lot of smaller details that need to be
    #       carefully considered by anyone wishing to edit it, see:
    #        - https://github.com/ActivityWatch/sd-core/pull/73
