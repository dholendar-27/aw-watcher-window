...
from sd_cli.log import find_oldest_log, print_log, LOGLEVELS
...
def qt(ctx):
    """
     Run qt. This is a wrapper around sd - qt. If you want to run tests you must call this function in test_case.
...
def directories():
    """
     Print all directories used to store data and log files in / var / lib / sd_core.
    """
    # Print all directories
    from sd_core.dirs import get_data_dir, get_config_dir, get_cache_dir, get_log_dir
...
def logs(
    ...
    """
    from sd_core.dirs import get_log_dir
